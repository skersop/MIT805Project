...
public class CountCategoryCodes {
  
	public static class CountCategoryCodesMapper 
	...
	public static class CountCategoryCodesReducer 
	...
	public static void main(String[] args) throws Exception {
		...
		job.setJarByClass(CountCategoryCodes.class);
		job.setMapperClass(CountCategoryCodesMapper.class);
		job.setCombinerClass(CountCategoryCodesReducer.class);
		job.setReducerClass(CountCategoryCodesReducer.class);
